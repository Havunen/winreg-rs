...
windows_link::link!("advapi32.dll" "system" fn RegCopyTreeW(hkeysrc : HKEY, lpsubkey : PCWSTR, hkeydest : HKEY) -> LSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyExW(hkey : HKEY, lpsubkey : PCWSTR, samdesired : REGSAM, reserved : u32) -> LSTATUS);
windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyTransactedW(hkey : HKEY, lpsubkey : PCWSTR, samdesired : REGSAM, reserved : u32, htransaction : HANDLE, pextendedparameter : *const core::ffi::c_void) -> LSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn RegLoadAppKeyW(lpfile : PCWSTR, phkresult : *mut HKEY, samdesired : REGSAM, dwoptions : u32, reserved : u32) -> LSTATUS);
...
windows_link::link!("ktmw32.dll" "system" fn RollbackTransaction(transactionhandle : HANDLE) -> BOOL);
